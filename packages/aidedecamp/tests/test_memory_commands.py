...
from aidedecamp.memory.commands import (
    forget_memory,
    list_memories,
    remember_fact,
    resolve_memory,
...
from aidedecamp.app import AppContext  # noqa: E402
from aidedecamp.config import Settings  # noqa: E402
from aidedecamp.dispatcher import handle_slack_message  # noqa: E402
...
from aidedecamp.cli.memory_cmd import (  # noqa: E402
    run_memory_forget,
    run_memory_list,
    run_memory_remember,
)
...
def _settings():
    return Settings.from_env({"ADC_MEM0_URL": ""})
