...
from aidedecamp.ingestion.polling import (
...
def test_chat_synthesizes_workspace_event_shape():
    ...
    from aidedecamp.ingestion import process_chat_event
...
def test_event_type_constant_matches_chat_events():
    from aidedecamp.ingestion.chat_events import _MESSAGE_CREATED as REAL
    from aidedecamp.ingestion.polling import _MESSAGE_CREATED as MIRRORED
